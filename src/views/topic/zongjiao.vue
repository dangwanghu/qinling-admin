	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" v-on:click="refreshData" v-show="isHasPermission('\'zjgl_scan\'')">查询</el-button>
				</el-form-item>
				<el-form-item>
					<el-button type="primary" @click="handleAdd" v-show="isHasPermission('\'zjgl_new\'')">新增</el-button>
				</el-form-item>
			</el-form>
		</el-col>
		...
		<el-table :data="data" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column label="操作" width="150" v-if="isHasPermission('\'zjgl_edit\'') || isHasPermission('\'zjgl_delete\'')">
				<template scope="scope">
					<el-button size="small" @click="handleEdit(scope.$index, scope.row)"  v-show="isHasPermission('\'zjgl_edit\'')">编辑</el-button>
					<el-button type="danger" size="small" @click="handleDel(scope.$index, scope.row)"  v-show="isHasPermission('\'zjgl_delete\'')">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
...
<script src="../../scripts/topic/zongjiao.js">
</script>
